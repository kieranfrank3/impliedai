    ...
    <>
      ...
      <SectionShell className="grid gap-6 pt-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="glass rounded-lg p-8">
          ...
          <h2 className="font-display text-4xl font-semibold">contact@impliedai.org</h2>
        ...
        <form action="https://formspree.io/f/xeedndea" method="POST" className="glass rounded-lg p-8">
          <Eyebrow>Preview request</Eyebrow>
          <div className="grid gap-4">
          <input
  name="name"
  className="rounded-md border border-white/10 bg-black/36 px-4 py-3 text-white outline-none transition placeholder:text-white/30 focus:border-signal/60"
  placeholder="Name"
/>
        <input
  name="email"
...
/>
  ...
  name="organization"
  className="rounded-md border border-white/10 bg-black/36 px-4 py-3 text-white outline-none transition placeholder:text-white/30 focus:border-signal/60"
  placeholder="Firm / school / role"
/>
      <textarea
  name="request"
  className="min-h-32 rounded-md border border-white/10 bg-black/36 px-4 py-3 text-white outline-none transition placeholder:text-white/30 focus:border-signal/60"
  placeholder="What would you want ImpliedAI to analyze?">
      </textarea>
           <button className="rounded-md border border-signal/55 px-5 py-3 text-sm font-bold text-cyanline transition hover:bg-signal/12" type="submit">
